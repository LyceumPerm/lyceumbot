...
TEACHER_WARNING = '''<b>Внимание:</b> в «режиме учителя» программа может учитывать пары некорректно, если имя преподавателя указано в расписании неправильно. Будьте внимательны и сверяйтесь с таблицей: /link'''