START = 'Привет! Это бот для просмотра расписания вашего класса в удобном формате.'

MORE_INFO = 'Больше информации по команде /help'

GET_CLASS_NUMBER = '''Укажите ваш класс с помощью кнопок ниже'''
...
GET_GROUP = 'С помощью кнопок ниже укажите вашу подгруппу (1 или 2)'
