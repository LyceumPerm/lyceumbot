...
# не бессмысленное копирование данных - могут быть разные сообщения для дат
REST_DAY = {'08.05': '08.05 — выходной!',
            '09.05': '09.05 — выходной!'}
...
TABLE_UPDATING_ERROR = 'Данные обновляются, попробуйте ещё раз через 5 секунд. Если это повторится, напишите об ошибке — @skosarevv.'
